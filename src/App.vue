        ...
        >
          <template v-slot:activator="{ on }">
            <v-avatar size="40"
              ><img
                v-on="on"
                src="https://image.freepik.com/free-vector/illustration-user-avatar-icon_53876-5907.jpg"
            /></v-avatar>
          </template>
...
export default {
  ...
  data: () => ({
    items: [
      ...
      { icon: "mdi-youtube-subscription", text: "Subscribe" },
      { icon: "mdi-history", text: "History" },
      { icon: "mdi-playlist-play", text: "More Content" },
